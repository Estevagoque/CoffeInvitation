...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').innerHTML = 'Te daré otra oportunidad, ¿estás segura Paula?';
        ...
        case 1:
            ...
            document.getElementById('noBtn').innerHTML = '¡¿Realmente estas segura OJITOS?!';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
            document.getElementById('sadGifContainer').style.display = 'none';
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = '¿Me romperás el cocoro si Dices que No:c?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 4:
            ...
            document.getElementById('noBtn').innerHTML = 'Di que si por favor! D:';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 5:
            ...
            document.getElementById('noBtn').innerHTML = 'última oportunidad Paula Pachecho >:c';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 7:
            ...
            document.getElementById('noBtn').innerHTML = 'Si dices que no estaré en serio muy muy triste';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 15:
            ...
            document.getElementById('noBtn').innerHTML = '... ya di que si Anda Siiiiiiiiiiiiiiiiiiiiiiiiiii??';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
